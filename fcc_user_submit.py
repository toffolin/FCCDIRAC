...
fcc_physics.set_configuration_file(
...
fccsw_path = '/eos/user/l/ltoffoli/FCC/FCCAnalyses/build'   #FIXME: set path to FCC/FCCSW build folder, '/build/<YOUR_USERNAME>/FCC/FCCSW'
...
#fccsw.add_paths(['/afs/cern.ch/user/<YOUR_INITIAL>/<YOUR_USERNAME>/foo.bar',
#                 '/afs/cern.ch/user/<YOUR_INITIAL>/<YOUR_USERNAME>/HelloWorld'])
